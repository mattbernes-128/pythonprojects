...
sys.path.append(r'/docker_projects/prod_lib')
from web_tools import logger_setup, init_driver, find_element_wait, find_elements_wait

script_outputs_directory = r'C:\Users\mattb\PycharmProjects\pythonprojects\docker_projects\airflow-docker\china_econ_data\script_outputs'
logger = logger_setup()
